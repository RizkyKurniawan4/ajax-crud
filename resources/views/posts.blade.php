...
<head>
    ...
    <title>Laravel Ajax CRUD - Mochamad Rizky Kurniawan</title>
    <style>
        body {
...
<body>
    ...
    <div class="container" style="margin-top: 50px">
        <div class="row">
            <div class="col-md-12">
                <h4 class="text-center">LARAVEL CRUD AJAX - <a href="Mochamad Rizky Kurniawan">Mochamad Rizky Kurniawan</a></h4>
